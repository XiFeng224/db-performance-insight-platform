...
import { Alert, Button, Card, Col, Descriptions, Drawer, Row, Select, Space, Switch, Table, Tag, Typography, Statistic, Progress, Checkbox, message } from 'antd';
  ...
  return (
    <div className="fade-in">
      ...
      <Row gutter={[16, 16]}>
        ...
        <Col xs={24} lg={12}>
          <Card title="校园应急Runbook" loading={loading}>
      ...
      <Card title="操作留痕与复盘" style={{ marginTop: 16 }}>
        ...
        <Table
          ...
          dataSource={logs.map((l, idx) => ({ key: `${l.time}-${idx}`, ...l }))}
