        ...
        <Col xs={24} lg={16}>
          <Card title="报修信息填写（校园场景）">
            <Form form={form} layout="vertical" onFinish={onFinish} initialValues={{ category: 'teaching_support', severity: 'medium', affected_people: 30 }}>
              ...
              <Form.Item>
                <Button type="primary" htmlType="submit" loading={submitting}>提交工单并进入校园值班流程</Button>
              </Form.Item>
            </Form>
          </Card>
        </Col>
        ...
        <Col xs={24} lg={8}>
          ...
          <Card title="快捷操作" extra={<SafetyCertificateOutlined />}>
            <Space direction="vertical" style={{ width: '100%' }}>
              <Button block onClick={() => message.info('可在 AI 值班助手中进行智能受理')}>前往AI智能受理</Button>
              <Button block onClick={() => message.info('可在进度看板中查看处理状态')}>查看工单进度看板</Button>
            </Space>
          </Card>
        </Col>
      </Row>
