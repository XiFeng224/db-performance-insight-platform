...
const dutyAssignees = [
  { name: '陈老师', role: '中心值班老师', shift: '08:00 - 16:00' },
  { name: '李同学', role: '机房学生助理', shift: '08:00 - 20:00' },
  { name: '王同学', role: '社团技术负责人', shift: '12:00 - 24:00' },
];
    ...
    <div className="fade-in">
      ...
      <Row gutter={[16, 16]} style={{ marginBottom: 12 }}>
        ...
        <Col xs={24} lg={8}>
          <Card title="值班接单人">
            <List
              dataSource={dutyAssignees}
              renderItem={(item) => (
                <List.Item>
                  <Space direction="vertical" size={2}>
                    <Space>
                      <Tag color="blue" icon={<UserOutlined />}>{item.name}</Tag>
