  ...
  return (
    <div className="fade-in">
      <Card
        style={{
          marginBottom: 16,
          background: 'linear-gradient(130deg, #eef2ff 0%, #f5f3ff 55%, #ecfeff 100%)',
          border: '1px solid #c7d2fe',
        }}
      >
        <Space direction="vertical" size={10} style={{ width: '100%' }}>
          <Space align="center" wrap>
            <Avatar size={44} style={{ backgroundColor: '#4f46e5' }} icon={<SafetyCertificateOutlined />} />
            <div>
              <Title level={2} style={{ margin: 0 }}>校园值班响应与应急协作平台</Title>
              <Text type="secondary">Campus Oncall Command Portal</Text>
            </div>
          </Space>
        ...
        <Col xs={24} lg={16}>
          <Card title="值班统一入口" style={{ marginBottom: 16 }}>
            <Space wrap>
              ...
              <Button icon={<FileSearchOutlined />} onClick={() => navigate('/ai-assistant')}>校园AI值班助手</Button>
